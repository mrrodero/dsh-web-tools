...
import { closeIndexStore, configureIndexStore, indexPage } from '../../src/web-local-index/store.ts'
import { ftsMatchQuery, rrf, searchLocal } from '../../src/web-local-index/search.ts'
